...
public class Cube extends baseObjet {
    ...
    public void setVertex(LightShaderProgram programTexture){
        positionArray.setVertexAttribPointer(0, programTexture.getPositionLocation(), Constantes.mPositionDataSize, 0);
        couleurArray.setVertexAttribPointer(0, programTexture.getColorLocation(), Constantes.mColorDataSize, 0);
        normalArray.setVertexAttribPointer(0, programTexture.getNormalLocation(), Constantes.mNormalDataSize, 0);
        textureArray.setVertexAttribPointer(0, programTexture.getTexCoordinate(), Constantes.mTextureCoordinateDataSize, 0);
    }
}
